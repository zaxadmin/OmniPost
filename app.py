...
<style>
    ...
    /* Alertes (Fond sombre, bordure Cyan) */
    .stAlert {
...
# --- 8. DASHBOARD ET LOGIQUE DE VALIDITÉ ---
    ...
    if st.session_state.validite is None:
        ...
        with c1:
            ...
            if st.button(f"Lancer l'essai ({d_txt})"):
        ...
        st.markdown("<div style='background:rgba(255,255,255,0.1); padding:15px; border-radius:10px; border:1px solid #00E5FF; text-align:center;'>⌛ Votre Pass a expiré. Votre profil est en veille.</div>", unsafe_allow_html=True)
...
if st.session_state.footer_view == "mentions":
    ...
    st.markdown("<div style='color:white;'>📜 <b>CGV</b> : Pass 90j (49€ Recruteur / 3€ Candidat). Paiement sécurisé sans remboursement.</div>", unsafe_allow_html=True)
elif st.session_state.footer_view == "rgpd":
    st.markdown("<div style='color:white;'>🔒 <b>RGPD</b> : Vos données sont protégées et supprimables sur demande.</div>", unsafe_allow_html=True)
